...
7. 游戏开始tp的坐标为世界坐标周围，需自己设置，输入/tag @s worldset可以使自己不被传送到大厅
...
* 该数据包在1.21.11版本中编写，并且应该支持1.21.X的版本（this_hacker告诉你，加了1.21.11的新配方，所以还是尽量用最新版本游玩）
...
* this_hacker 优化了数据包结构，新增初始大厅，负责了非常多配方的筛选和导入
