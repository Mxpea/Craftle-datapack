...
#Stonecutter
execute if score type craftle_table matches 13 run data modify storage craftle:answer item_ans set value "Observer"
...
#If the corresponding position in the recipe is empty, no need to write it
