...
tellraw @a[tag=debug] [{"text":"[get ansval]","color":"aqua",click_event:{action:"run_command",command:"scoreboard players get type craftle_table"}}]
...
execute as @a[tag=check_ans] unless items entity @s container.9 * run item replace entity @s container.9 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.10 * run item replace entity @s container.10 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.11 * run item replace entity @s container.11 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.18 * run item replace entity @s container.18 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.19 * run item replace entity @s container.19 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.20 * run item replace entity @s container.20 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.27 * run item replace entity @s container.27 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.28 * run item replace entity @s container.28 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.29 * run item replace entity @s container.29 with minecraft:barrier[custom_name={text:"合成表空位"},lore=[{text:"使用它代替合成表为空的位置",color:gray}]]
