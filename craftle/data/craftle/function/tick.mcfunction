...
#tellraw @a[tag=pre_check_ans] [{"text":"[Get Empty Slot]","color":"green",click_event:{action:"run_command",command:"trigger craftle_settings set 199"}},{text:"      Use this to replace empty parts of the crafting table, throwing it will make it disappear",color:"gray"}]
...
execute if score intro craftle_DISCOUNT matches 1560 run tellraw @a [{text:"<Aurelith_FW> For example: If the recipe needs 2 planks but you place 3, you'll still get three yellow/green hints!"}]
execute if score intro craftle_DISCOUNT matches 1520 run tellraw @a [{text:"<Aurelith_FW> Let me give an example with a minecart as the target item:"}]
execute if score intro craftle_DISCOUNT matches 1480 run tellraw @a "For example, if your submitted items are:"
...
execute if score intro craftle_DISCOUNT matches 1480 run tellraw @a [{atlas: "minecraft:items",sprite:"item/iron_ingot"},{atlas: "minecraft:items",sprite:"item/iron_ingot"},{atlas: "minecraft:items",sprite:"item/iron_ingot"}]
execute if score intro craftle_DISCOUNT matches 1440 run tellraw @a "Then, after submission, chat will show this information"
...
execute if score intro craftle_DISCOUNT matches 1400 run tellraw @a {text:"<Aurelith_FW> In short, your task is to turn all these blocks green!"}
execute if score intro craftle_DISCOUNT matches 1360 run tellraw @a {text:"<Aurelith_FW> But remember... there will be a cooldown after submission w"}
...
execute as @a[tag=check_ans] unless items entity @s container.9 * run item replace entity @s container.9 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.10 * run item replace entity @s container.10 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.11 * run item replace entity @s container.11 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.18 * run item replace entity @s container.18 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.19 * run item replace entity @s container.19 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.20 * run item replace entity @s container.20 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.27 * run item replace entity @s container.27 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.28 * run item replace entity @s container.28 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
execute as @a[tag=check_ans] unless items entity @s container.29 * run item replace entity @s container.29 with minecraft:barrier[custom_name={text:"Crafting Empty Slot"},lore=[{text:"Use this to replace empty positions in the crafting table",color:gray}]]
